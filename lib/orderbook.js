...
OrderBook.prototype.countBidAmount = function(price){
    return this.bids.reduce(function(r,v){
        if(v[0] >= price) r += v[1]
        return r;
    }, 0)
}
OrderBook.prototype.countAskAmount = function(price){
    return this.asks.reduce(function(r,v){
        if(v[0] <= price) r += v[1]
        return r;
    }, 0)
}
